...
export default function CardReply({id, score, content, date, image, username, idCommentParent, userNameParent}) {
    const {currentUser, upScoreReply, downScoreReply, deleteCommentReply, updateCommentReply} = useContext(CommentContext);
    ...
    return(
        <div className="bg-white rounded-lg p-5">
            <div className="flex flex-row items-start gap-5">
                <div className="flex flex-col items-center justify-between gap-y-3 py-2 px-3 rounded-lg bg-gris-light">
                ...
                <div className="w-full">
                    ...
                    {isEdit == id ? (
                        ...
                        <p className="text-gray-500 text-lg mt-4 font-semibold"><span className="texto-morado font-semibold">@{userNameParent}</span> {content}</p>
                    )}
                </div>
            </div>
        </div>
